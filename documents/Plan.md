...
5. При обращении к <http://localhost:8080/api/v1/pay> с невалидными полями должны быть получены: код - 500 и сообщение - "400 Bad Request".
6. При обращении к <http://localhost:8080/api/v1/credit> с невалидными полями должны быть получены: код - 500 и сообщение - "400 Bad Request".
